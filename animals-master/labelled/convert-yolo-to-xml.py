...
folder_holding_yolo_files = 'labels/'
yolo_class_list_file = 'predefined_classes.txt'
...
for each_yolo_file in os.listdir(folder_holding_yolo_files):
  if each_yolo_file.endswith("txt"):
    ...
    image_height = 64
      ...
      # Start the XML file
    with open(folder_holding_yolo_files + os.sep + 'XML' + os.sep + each_yolo_file.replace('txt', 'xml'), 'w') as f:
        f.write('<annotation>\n')
